  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="With Construction tool rental v1, empowering individual customers to rent construction tools from a central supplier with multiple outlets. Your tool, your project, your success."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`With Construction tool rental v1, empowering individual customers to rent construction tools from a central supplier with multiple outlets. Your tool, your project, your success.`}
            </Text>
            <Box
